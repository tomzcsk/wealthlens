...
export const LoanSummaryCard = (): ReactNode => {
  ...
  return (
    <Link
      to="/loans"
      className="block bg-card rounded-2xl border border-ink-200 shadow-sm p-6 hover:border-primary-ink hover:shadow-md transition"
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span
            aria-hidden="true"
            className="flex h-8 w-8 items-center justify-center rounded-lg bg-expense-50 text-base"
          >
            💰
          </span>
      ...
      <div className="mt-4 space-y-3">
        <div>
          <div className="text-xs text-ink-500">เหลือต้องชำระ</div>
